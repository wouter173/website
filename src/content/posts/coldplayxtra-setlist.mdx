---
title: Setlist maker
summary: A project in collaboration with @coldplayxtra to create a setlist maker for the MOTS tour.
type: project
...
<Image src="/images/setlist-result.png" alt="" bg="#19111d" width={697} height={1163} />
