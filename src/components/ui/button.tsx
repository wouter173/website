  ...
  "active:scale-95 transition-all inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium",
  {
    variants: {
      variant: {
        ...
        primary:
          "border-2 border-slate-100 bg-slate-100 pr-1.5 text-black enabled:hover:border-black enabled:hover:bg-slate-100 enabled:hover:outline enabled:hover:outline-2 outline-[#6F6F70] enabled:focus-visible:border-black enabled:focus-visible:outline enabled:focus-visible:outline-2 disabled:opacity-70",
