...
//                           <span className="line-clamp-2 text-sm text-neutral-600"> {post.metadata.summary}</span>
//                         ) : null}
//                       </div>
//                     </ViewTransitionLink>
//                   </li>
...
//             <div className="relative top-[70%] z-40 size-3 rotate-45 rounded-tl-xs border border-stroke bg-[#FFF]" />
//           </NavigationMenu.Indicator>
//         </NavigationMenu.List>

//         <div className="pointer-events-auto absolute top-full left-0 flex w-full justify-center">
//           <NavigationMenu.Viewport className="data-[state=closed]:animate-scale-out data-[state=open]:animate-scale-in relative mt-2.5 w-full min-w-3xs origin-[top_center] overflow-hidden rounded-2xl border border-stroke bg-[#FFF] p-2 transition-[width,_height] duration-300 sm:w-[var(--radix-navigation-menu-viewport-width)+1px]" />
//         </div>
//       </NavigationMenu.Root>
//     </div>
//   )
