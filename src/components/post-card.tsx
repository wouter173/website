...
export const PostCard = ({ post, className, ...props }: { post: Post } & ComponentProps<'div'>) => {
  return (
    <article className={cn('group/card relative z-20 flex flex-col gap-6 rounded-lg px-6 py-6 transition-all', className)} {...props}>
      <div className="bg-stroke absolute -inset-px -z-20 rounded-[9px] shadow-xs transition-all [clip-path:polygon(0_0,calc(100%-32px)_0,100%_32px,100%_100%,0_100%)] group-hover/card:[clip-path:polygon(0_0,calc(100%-40px)_0,100%_40px,100%_100%,0_100%)] dark:bg-[#1F1F1F] dark:shadow-2xl" />
      <div className="absolute inset-0 -z-10 rounded-lg bg-white transition-all [clip-path:polygon(0_0,calc(100%-32px)_0,100%_32px,100%_100%,0_100%)] group-hover/card:[clip-path:polygon(0_0,calc(100%-40px)_0,100%_40px,100%_100%,0_100%)] dark:bg-black" />
